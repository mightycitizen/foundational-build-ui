...
`,position:{start:1370,end:1370}}],precompiled:!0});a.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),o(a.render({attributes:new l(e),...t}))}catch(e){return o("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/informational/countdown/countdown.twig: "+e.toString())}},h={title:"Components/Informational/Countdown"},y=t=>m(t),s=new Date;s.setMonth(s.getMonth()+1);s.setHours(s.getDate()+1);const w=s.getTime(),g={date:w},n=y.bind({});n.args=g;var i,r,p;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`args => {

import{t as c,T as l}from"./twig-BXd3Gfe2.js";import{D as u,a as d}from"./twig-foVUGi9y.js";import"./_commonjsHelpers-BosuxZz1.js";d(l);l.cache(!1);const s=t=>t,p=(t={})=>{const o=c.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/containers/modal/modal.twig",data:[{type:"raw",value:`
...
<\/script>
`,position:{start:0,end:0}}],precompiled:!0});o.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),s(o.render({attributes:new u(e),...t}))}catch(e){return s("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/containers/modal/modal.twig: "+e.toString())}},w={title:"Components/Containers/Modal",argTypes:{heading:{control:"text"},summary:{control:"text"},subheading:{control:"text"},button:{url:{control:"text"},text:{control:"text"}},categories:[{text:{control:"text"},url:{control:"text"}}]}},m=t=>p(t),g={heading:"Hero",summary:"Summary",subheading:"Subheading"},n=m.bind({});n.args=g;var r,a,i;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`args => {

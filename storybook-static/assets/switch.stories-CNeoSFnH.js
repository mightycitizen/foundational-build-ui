import{t as c,T as l}from"./twig-BXd3Gfe2.js";import{D as d,a as u}from"./twig-foVUGi9y.js";import"./_commonjsHelpers-BosuxZz1.js";u(l);l.cache(!1);const a=e=>e,m=(e={})=>{const r=c.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/forms/switch/switch.twig",data:[{type:"raw",value:`   <div x-data="{ isChecked: false }" class="flex items-center">
    ...
    </div>`,position:{start:0,end:0}}],precompiled:!0});r.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),a(r.render({attributes:new d(t),...e}))}catch(t){return a("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/forms/switch/switch.twig: "+t.toString())}},g={title:"Components/Forms/Switch",argTypes:{required:{control:{type:"boolean"}}}},p=e=>m(e),s=p.bind({});s.args={label:"Switch",id:"switch",name:"switch"};var n,i,o;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`args => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return \`<div>\${label}</div>\`;
  return twig(args);
}`,...(o=(i=s.parameters)==null?void 0:i.docs)==null?void 0:o.source}}};const b=["Switch"];export{s as Switch,b as __namedExportsOrder,g as default};

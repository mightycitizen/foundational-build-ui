import{t as p,T as r}from"./twig-BXd3Gfe2.js";import{D as u,a as c}from"./twig-foVUGi9y.js";import"./_commonjsHelpers-BosuxZz1.js";c(r);r.cache(!1);const s=t=>t,d=(t={})=>{const n=p.twig({id:"/Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/inline-text/tooltip/tooltip.twig",data:[{type:"raw",value:`<span x-data="{
    show: false,
    tooltipClasses: '',
    showTooltip(event) {
...
`,position:{start:2006,end:2006}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let e=t.defaultAttributes?t.defaultAttributes:[];return Array.isArray(e)||(e=Object.entries(e)),s(n.render({attributes:new u(e),...t}))}catch(e){return s("An error occurred whilst rendering /Users/jabelmunoz/Documents/projects/foundational-build/src/stories/components/inline-text/tooltip/tooltip.twig: "+e.toString())}},b={title:"Components/Inline Text/Tooltip"},h=t=>d(t),o=h.bind({});o.args={text:"Trigger Text",tooltip:"Tooltip Text"};var i,a,l;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`args => {
  // You can either use a function to create DOM elements or use a plain html string!
  // return \`<div>\${label}</div>\`;
  return twig(args);
}`,...(l=(a=o.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};const m=["Tooltip"];export{o as Tooltip,m as __namedExportsOrder,b as default};
